...
var GameGlobal = /** @class */ (function () {
    ...
    GameGlobal.BONESCONFIG = (_a = {},
        _a[GameGlobal.BONE_BODY] = { Rotation: 167, Length: 1 },
        _a[GameGlobal.BONE_HEAD] = { Rotation: 175, Length: 1 },
        _a[GameGlobal.BONE_NECK] = { Rotation: 198, Length: 0.125 },
        _a[GameGlobal.BONE_RIGHTUPARM] = { Rotation: -2, Length: 0.5 },
        _a[GameGlobal.BONE_RIGHTDOWNARM] = { Rotation: -20, Length: 0.3 },
        _a[GameGlobal.BONE_RIGHTHAND] = { Rotation: -30, Length: 0.5 },
        _a[GameGlobal.BONE_LEFTUPARM] = { Rotation: -24, Length: 0.5 },
        _a[GameGlobal.BONE_LEFTDOWNARM] = { Rotation: -47, Length: 0.3 },
        _a[GameGlobal.BONE_LEFTHAND] = { Rotation: -48, Length: 0.5 },
        _a[GameGlobal.BONE_RIGHTUPLEG] = { Rotation: 6, Length: 0.75 },
        _a[GameGlobal.BONE_RIGHTDOWNLEG] = { Rotation: 8, Length: 1 },
        _a[GameGlobal.BONE_RIGHTFOOT] = { Rotation: -80, Length: 0.5 },
        _a[GameGlobal.BONE_LEFTUPLEG] = { Rotation: -17, Length: 0.75 },
        _a[GameGlobal.BONE_LEFTDOWNLEG] = { Rotation: 3, Length: 1 },
        _a[GameGlobal.BONE_LEFTFOOT] = { Rotation: -80, Length: 0.5 },
        _a);
    return GameGlobal;
}());
