...
var GameGlobal = /** @class */ (function () {
    ...
    GameGlobal.BONESCONFIG = (_a = {},
        ...
        _a[GameGlobal.BONE_RIGHTUPARM] = { Rotation: -90, Length: 0.5 },
        _a[GameGlobal.BONE_RIGHTDOWNARM] = { Rotation: -90, Length: 0.3 },
        _a[GameGlobal.BONE_RIGHTHAND] = { Rotation: -90, Length: 0.5 },
        _a[GameGlobal.BONE_LEFTUPARM] = { Rotation: -90, Length: 0.5 },
        _a[GameGlobal.BONE_LEFTDOWNARM] = { Rotation: -90, Length: 0.3 },
        _a[GameGlobal.BONE_LEFTHAND] = { Rotation: -90, Length: 0.5 },
        _a[GameGlobal.BONE_RIGHTUPLEG] = { Rotation: -6, Length: 0.75 },
        _a[GameGlobal.BONE_RIGHTDOWNLEG] = { Rotation: 6, Length: 1 },
        _a[GameGlobal.BONE_RIGHTFOOT] = { Rotation: -90, Length: 0.3 },
        _a[GameGlobal.BONE_LEFTUPLEG] = { Rotation: -6, Length: 0.75 },
        _a[GameGlobal.BONE_LEFTDOWNLEG] = { Rotation: 6, Length: 1 },
